/*
 * Я реализовал задачу с морским боем по правилами, по которым мы играли в детстве.
 * 3-х и 4-х палубные корабли могут быть изогнутые, но 4-х палубный не может быть квадратом.
 */
